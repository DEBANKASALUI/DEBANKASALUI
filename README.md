...
🔧 Technologies & Tools:
-  Programming Languages: Java, Java 8+, Java 17, Java 21.
-  Frameworks: Spring, Spring Boot, Hibernate.
-  JPA Databases: MySQL, Oracle, PostgresSQL, DB2, Relational Databases, Microsoft SQL Server, NoSQL Databases- MongoDB.
-  Version Control Systems: Git, GitHub, GitLab.
-  Unit Testing: Junit5.
-  API Testing: Postman, SOAP UI.
-  IDE/Tools: Eclipse, Intellij, STS.
-  Build Tools: Apache Maven: Tomcat, Jetty.
-  Caching: EhCache, Redis Cache.
-  Messaging: Kafka.
-  Cloud: AWS.
